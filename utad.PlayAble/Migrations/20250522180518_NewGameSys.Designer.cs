...
namespace utad.PlayAble.Migrations
{
    ...
    [Migration("20250522180518_NewGameSys")]
    partial class NewGameSys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("utad.PlayAble.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("utad.PlayAble.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("utad.PlayAble.Models.UserFavoriteGame", b =>
                {
                    b.HasOne("utad.PlayAble.Models.Game", "Game")
                        .WithMany("UserFavorites")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("utad.PlayAble.Models.ApplicationUser", "User")
